...
function Book() {
  return (
    <div className='Heroes flex justify-center items-center'>
        <img src={image} className='videos'/>
        <div className='bg-overlay'></div>
        <div className="display flex justify-between items-center">
          <div className="mr-[80px]">
              <h1 className="font-bold text-white text-4xl text-[Poppins]"><span className="text-[#7EC5FF]">Book a Demo</span> and Transform Your <br></br>Testing  Experience</h1>
              <h3 className="text-white mt-4 text-xl font-bold">Try it out and see the possibilities!</h3>
          </div>
          <div>
            <form>
              <div className="flex gap-2 items-center mb-2">
                <h4 className="text-md text-[#7EC5FF] font-bold font-[Poppins]">Name<sup>*</sup></h4>
                <input type="text" className="w-[340px] ml-5 px-16 py-2 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-[#7EC5FF]" placeholder="Enter Name"/>
              </div>
              <div className="flex gap-2 items-center mb-2">
                <h4 className="text-md text-[#7EC5FF] font-bold font-[Poppins]">Email<sup>*</sup></h4>
                <input type="text" className=" w-[340px] ml-5 px-16 py-2 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-[#7EC5FF] m-3" placeholder="Enter Email"/>
              </div>
