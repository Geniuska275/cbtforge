        ...
        <div className='display '>
         ...
         <marquee> <h1 className=' tests font-bold text-6xl text-center text-white font-[Poppins]'>
           ...
           <h2 className='text font-bold text-white text-center text-3xl mt-4 font-[Poppins]'>Multi-purpose Cloud-Based Assessment Platform</h2>
            ...
            <div className='items-center column flex gap-3 mt-4 ml-[200px]'>
              <button className='btn py-2 px-8 bg-[#7EC5FF] rounded-3xl font-bold font-[Poppins] hover:bg-black hover:border hover:text-white'>GET STARTED</button>
              <button className='btn py-2 px-8 bg-black border rounded-3xl font-bold font-[Poppins] text-white hover:bg-[#7EC5FF] hover:border hover:text-black'>SEE ALL PLANS</button>
