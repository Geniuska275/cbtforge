...
<input type="email" className=" btn px-10 py-2 mt-3 border border-[#7EC5FF] rounded-lg border-2 border-gray-300 focus:outline-none focus:border-[#7EC5FF]" placeholder="Enter Your Email..."/>
  <button className=" btnss h-[40px] w-[200px] bg-[#7EC5FF]  rounded-xl font-bold mt-3 hover:border hover:text-white hover:bg-black">TRY 4 FREE</button>
</div>
